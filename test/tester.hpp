...
namespace CppUnitTestFramework {
    ...
    namespace Assert {
        ...
        inline std::optional<AssertException> Close(float left, float right, float percentage_tolerance) {
            ...
            float percentage_left = std::abs((int) (diff / left));
            float percentage_right = std::abs((int) (diff / right));
        ...
        inline std::optional<AssertException> Close(double left, double right, double percentage_tolerance) {
            ...
            double percentage_left = std::abs( (int)(diff / left));
            double percentage_right = std::abs( (int) (diff / right));
